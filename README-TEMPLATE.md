...
* [stream10, 10, {{ .DOCKER_TAG }}-stream10, {{ .DOCKER_TAG }}](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
* [latest, stream, stream9, 9, {{ .DOCKER_TAG }}-stream9, {{ .DOCKER_TAG }}](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
