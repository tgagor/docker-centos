...
* [latest, centos8, 8, 1.5.1-centos8, 1.5.1](https://github.com/tgagor/docker-centos/blob/master/centos8/Dockerfile)
* [stream, stream8, 1.5.1-stream8](https://github.com/tgagor/docker-centos/blob/master/centos8/Dockerfile)
* [stream9, 1.5.1-stream9](https://github.com/tgagor/docker-centos/blob/master/centos8/Dockerfile)
* [centos7, 7, 1.5.1-centos7](https://github.com/tgagor/docker-centos/blob/master/centos7/Dockerfile)
