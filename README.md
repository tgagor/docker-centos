...
* [stream10, 10, 4.5.3-stream10, 4.5.3](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
* [latest, stream, stream9, 9, 4.5.3-stream9, 4.5.3](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
