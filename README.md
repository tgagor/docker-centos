...
* [stream10, 10, 4.0.12-stream10, 4.0.12](https://github.com/tgagor/docker-centos/blob/master/stream10/Dockerfile)
* [latest, stream, stream9, 9, 4.0.12-stream9, 4.0.12](https://github.com/tgagor/docker-centos/blob/master/stream9/Dockerfile)
