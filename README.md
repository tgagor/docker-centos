...
* [latest, stream, stream9, 9, 3.1.2-stream9, 3.1.2](https://github.com/tgagor/docker-centos/blob/master/stream9/Dockerfile)
* [stream8, 8, 3.1.2-stream8](https://github.com/tgagor/docker-centos/blob/master/stream8/Dockerfile)
* [centos7, 7, 3.1.2-centos7](https://github.com/tgagor/docker-centos/blob/master/centos7/Dockerfile)
