...
* [latest, stream, stream9, 9, 3.2.0-stream9, 3.2.0](https://github.com/tgagor/docker-centos/blob/master/stream9/Dockerfile)
* [stream8, 8, 3.2.0-stream8](https://github.com/tgagor/docker-centos/blob/master/stream8/Dockerfile)
* [centos7, 7, 3.2.0-centos7](https://github.com/tgagor/docker-centos/blob/master/centos7/Dockerfile)
