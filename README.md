...
* [stream10, 10, 4.1.2-stream10, 4.1.2](https://github.com/tgagor/docker-centos/blob/master/stream10/Dockerfile)
* [latest, stream, stream9, 9, 4.1.2-stream9, 4.1.2](https://github.com/tgagor/docker-centos/blob/master/stream9/Dockerfile)
