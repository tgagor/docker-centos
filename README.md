...
* [stream10, 10, 4.4.0-stream10, 4.4.0](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
* [latest, stream, stream9, 9, 4.4.0-stream9, 4.4.0](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
