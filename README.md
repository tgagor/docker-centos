...
* [stream10, 10, 4.5.8-stream10, 4.5.8](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
* [latest, stream, stream9, 9, 4.5.8-stream9, 4.5.8](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
