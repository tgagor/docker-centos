...
* [stream10, 10, 4.5.2-stream10, 4.5.2](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
* [latest, stream, stream9, 9, 4.5.2-stream9, 4.5.2](https://github.com/tgagor/docker-centos/blob/master/Dockerfile)
